...
/*jshint newcap: false */
/*global React */
define(['react', 'react-bootstrap', 'jquery', 'dashboard/Header', 'neighborhood/Map', 'validator', 'dateRangePicker'],
    function (React, Bootstrap, $, Header, Map, Validator, dateRangePicker) {
        'use strict';
        ...
        var PinForm = React.createClass({
            ...
            componentDidMount: function () {
                ...
                // Todo: fix map.resizeMap is not a function
                // Map.resizeMap();
