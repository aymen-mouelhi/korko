...
var SignUpForm = React.createClass({
    ...
    render: function () {
        ...
        return (
            ...
            <form role="form" acceptCharset="UTF-8" action="/auth/local/register" className="signup-form" method="post">
                ...
                <div className="signup-form-fields">
                    ...
                    <div className="control-group row-space-1" id="inputLast">
                        <input type="text" name="lastName" placeholder="Last name"
                               className="decorative-input inspectletIgnore"/>
                    </div>
                    ...
                    <div className="control-group row-space-top-3 row-space-1">
                        ...
                        <strong data-behavior="tooltip"
                                aria-label="To sign up, you must be 18 or older. Other people won’t see your birthday.">
                    ...
                    <label className="checkbox">
                        ...
                        <input checked="checked" id="user_profile_info_receive_promotional_email"
                               name="user_profile_info[receive_promotional_email]" onChange={this.subscribe}
                               type="checkbox" value="1"/>
                        Tell me about Korko news
                    </label>

                    <div className="row-space-2 row-space-top-2">
                        <small>
                            By signing up, I agree to Korko's
...
var SignUpSocial = React.createClass({
    showForm: function () {
        // Show From
        this.props.scope.showForm();
    },
    render: function () {
        return (
            <div>
                <div className="social-buttons">
                    <a href="https://www.facebook.com/v2.0/dialog/oauth?client_id=138566025676&amp;redirect_uri=https%3A%2F%2Fwww.airbnb.com%2Fauthenticate&amp;scope=email%2Cuser_birthday%2Cuser_likes%2Cuser_education_history%2Cuser_hometown%2Cuser_location%2Cuser_friends%2Cpublish_actions"
                       className="fb-button fb-blue btn icon-btn btn-block row-space-1 btn-large btn-facebook"
                    ...
                    <a href="/oauth_connect?service=google&amp;from=google_signup"
                       className="btn icon-btn btn-block row-space-1 btn-large btn-google">
                            <span className="icon-container">
                ...
                <div className="text-center">
                    <a href="#" onClick={this.showForm} className="create-using-email btn-block  row-space-2  icon-btn">
...
var SignUp = React.createClass({
    ...
    render: function () {
        return (
            <div className="modal show" role="dialog" aria-hidden="false" aria-labelledby="signup-modal-content"
                 aria-describedby="signup-modal-content">
                    ...
                    <div className="modal-cell">
                        <div className="modal-content signup" id="signup-modal-content">
                            ...
                            <div className="panel-padding panel-body">
                                {/* Social Sign Up */}
                                { this.state.social ? <SignUpSocial scope={this}/> : null }
                                {/* Email Setup */}
                                { this.state.email ? <SignUpForm scope={this}/> : null }
                                { this.state.social ?
                            ...
                            <div className="panel-body">
                                Already a Korko member?
                                <a href="#" className="modal-link link-to-login-in-signup" onClick={this.login}>
                                    Log in
                                </a>
                            </div>

                            <div id="social-media-data" data-show-weibo-button="" data-show-facebook-button="true"
