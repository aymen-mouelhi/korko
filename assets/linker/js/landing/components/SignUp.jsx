                ...
                <form role="form" acceptCharset="UTF-8" action="/auth/local/register" className="signup-form" method="post">
                    ...
                    <div className="signup-form-fields">
                        ...
                        <div className="control-group row-space-1" id="inputEmail">
                            <input type="email" name="email" placeholder="Email address" className="decorative-input inspectletIgnore" />

                        </div>

                        <div className="control-group row-space-1" id="inputPassword">
                            <input type="password" id="user_password" name="password" placeholder="Password" className="decorative-input inspectletIgnore" />
                        </div>
                        ...
                        <label className="checkbox">
                            ...
                            <input checked="checked" id="user_profile_info_receive_promotional_email" name="user_profile_info[receive_promotional_email]" onChange={this.subscribe} type="checkbox" value="1" />
