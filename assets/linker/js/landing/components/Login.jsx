...
define(['react'], function (React) {
    ...
    var Login = React.createClass({
        ...
        render: function () {
            return (
                <div className="modal show" role="dialog" aria-hidden="false" aria-labelledby="login-modal-content" aria-describedby="login-modal-content">
                        ...
                        <div className="modal-cell">
                            <div className="modal-content signup" id="login-modal-content">
                                ...
                                <div className="panel-padding panel-body">
                                    ...
                                    <a href="/auth/facebook" className="fb-button fb-blue btn icon-btn btn-block btn-large row-space-1 btn-facebook" data-populate_uri="" data-redirect_uri="https://www.airbnb.com/authenticate">
                                    ...
                                    <a href="/oauth_connect?service=google&amp;from=google_signup" className="btn icon-btn btn-block btn-large row-space-1 btn-google">
                                        <span className="icon-container">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <a href="/signup_login" className="modal-link link-to-signup-in-login" data-modal-href="/signup_modal" data-modal-type="signup">
                                            Sign up
                                        </a>
                                    </div>
                                </div>
